...
class UserTest < ActiveSupport::TestCase
  ...
  test "should be valid" do 
    assert @user.valid?
    #the plain assert method succeeds if the
    #method returns true and fails if it returns false
  end
  ...
  test "email validation should accept valid addresses" do 
    ...
    valid_addresses.each do |valid_address|
      ...
      #second argument is error message, appears on fail 
    end
  end
  ...
  test "email addresses should be sabes as lower-case" do 
